...
function comparacion() {
  ...
  http.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.querySelector('#totalVentas2').textContent = res.totalVentas2.total;
      ...
      myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            ...
            label: 'Compras',
            data: [res.venta2.ene, res.venta2.feb, res.venta2.mar,
            res.venta2.abr, res.venta2.may, res.venta2.jun,
            res.venta2.jul, res.venta2.ago, res.venta2.sep,
            res.venta2.oct, res.venta2.nov, res.venta2.dic],
