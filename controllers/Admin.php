...
class Admin extends Controller
{
    ...
    public function index()
    {
        ...
        $data['proveedores'] = $this->model->getTotales('clientes2');
    ...
    public function modificar()
    {
        ...
        if (isset($_POST)) {
            ...
            $rango = strClean($_POST['rango']);
            $rangoc = strClean($_POST['rangoc']);
            $ticket = strClean($_POST['ticket']);
            $notasc = strClean($_POST['notasc']);
            $recibo = strClean($_POST['recibo']);
            $dui = strClean($_POST['dui']);
            $registro = strClean($_POST['registro']);
            $direccion = strClean($_POST['direccion']);
            $giro = strClean($_POST['giro']);
            ...
            if (empty($ruc)) {
                ...
                $res = array('msg' => 'EL RANGO ES REQUERIDO', 'type' => 'warning');

            } else if (empty($rangoc)) {
                $res = array('msg' => 'EL RANGOC ES REQUERIDO', 'type' => 'warning');
                ...
                $res = array('msg' => 'EL REGISTRO ES REQUERIDO', 'type' => 'warning'); 

                
            } else if (empty($giro)) {
                $res = array('msg' => 'EL GIRO ES REQUERIDO', 'type' => 'warning'); 
    ...
    public function comparacion($anio)
    {
        ...
        $data['venta2'] = $this->model->calcularVentasCompras('ventas2', $desde, $hasta, $this->id_usuario);

        $data['totalVentas'] = $this->model->totalVentasCompras('ventas', $desde, $hasta, $this->id_usuario);
        $data['totalVentas2'] = $this->model->totalVentasCompras('ventas2', $desde, $hasta, $this->id_usuario);
    ...
    public function topProductosExcel()
    {
        ...
        $hojaActiva->setCellValue('C1', 'Precio Venta2');
