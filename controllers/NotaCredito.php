...
class NotaCredito extends Controller
{
    ...
    public function index()
    {
        ...
        $data['busqueda'] = 'busquedaNotaCredito.js';
        ...
        if (!empty($datos['productos'])) {
            ...
            if (empty($idCliente)) {
                $res = array('msg' => 'EL CLIENTE ES REQUERIDO', 'type' => 'warning');
                    ...
                    $venta = $this->model->registrarVenta($datosProductos, $totalVenta, $fecha, $hora, $metodo, $descuento, $serie[0], $pago, $docuemi, $numdocu, " ", " ", " ", $idCliente, $this->id_usuario, $correlativo, $numeroControlDte, $uuid, $codPuntoVentaMH, $sello, $vExentas, $vIva, $vGravadas, $claseDoc);
    ...
    public function reporte($datos)
    {
		...
		$data['correlativo'] = $this->model->getMaxCorrelativo($data['venta']['docuemi']);
