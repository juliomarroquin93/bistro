...
class AdminModel extends Query{
    ...
    public function actualizar($ruc, $nombre, $telefono, $correo, $rango, $rangoc, $ticket, $notasc,
    $recibo, $dui, $registro, $giro, $direccion, $impuesto, $mensaje, $id)
    {
        $sql = "UPDATE configuracion SET ruc=?, nombre=?, telefono=?, correo=?, rango=?,
        rangoc=?, ticket=?, notasc=?, recibo=?, dui=?, registro=?, giro=?,
        direccion=?, impuesto=?, mensaje=? WHERE id=?";
        $array = array($ruc, $nombre, $telefono, $correo, $rango, $rangoc, $ticket, $notasc,
        $recibo, $dui, $registro, $giro, $direccion, $impuesto, $mensaje, $id);
