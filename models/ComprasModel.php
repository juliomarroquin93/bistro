...
class ComprasModel extends Query{
    ...
    public function registrarCompra($productos, $total, $fecha, $hora, $serie, $forma, $idproveedor, $idusuario)
    {
        $sql = "INSERT INTO compras (productos, total, fecha, hora, serie, forma, id_proveedor, id_usuario) VALUES (?,?,?,?,?,?,?,?)";
        $array = array($productos, $total, $fecha, $hora, $serie, $forma, $idproveedor, $idusuario);
