...
class PrincipalModel extends Query{
    ...
    {
        $sql = "SELECT u.id, u.nombre, u.correo, u.perfil, u.clave, u.estado, r.permisos,r.nombre as rol FROM usuarios u INNER JOIN roles r ON u.rol = r.id WHERE u.correo = '$correo' AND u.estado = 1";
