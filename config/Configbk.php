<?php
define('BASE_URL', 'http://interactivemenusv.com/posmandesa/');
define('HOST', 'localhost');
define('USER', 'u526756767_posman');
define('PASS', 'Posman27$');
define('DBNAME', 'u526756767_posman');
define('CHARSET', '');
define('TITLE', 'POS VENTA');
define('MONEDA', 'S/$ ');
define('HOST_SMTP', 'mail.fabianscorp.top');
define('USER_SMTP', 'carlos.fabian@fabianscorp.top');
...
//CreditoFiscal
define('creditoBase','DTE-03-00000000-600000000000000');
define('version',3);
...
//Consumidor Final
define('consumidorBase','DTE-01-00000000-640000000000000');
