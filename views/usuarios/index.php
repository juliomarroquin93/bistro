                ...
                <form class="p-4" id="formulario" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-2">
                            ...
                            <label for="departamento">Punto de Venta</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-list"></i></span>
                                <input class="form-control" list="listaPuntoVenta" name="puntoVenta" id="puntoVenta" placeholder = "punto de Venta">
									<datalist id="listaPuntoVenta">
									...
									$sql = "select codPuntoVentaMH from puntoVentas";
									$result = $conn->query($sql);

									if ($result->num_rows > 0) {
									  // output data of each row
									  while($row = $result->fetch_assoc()) {
										echo "<option value='".$row["codPuntoVentaMH"]."'>";
									  }
									} else {
									  echo "0";
									}
