    ...
    <table id="datos-empresa">
        <tr>
            ...
            <td class="info-empresa">
                ...
                <p>Registro: <?php echo $data['empresa']['registro']; ?></p>
                <p>Teléfono: <?php echo $data['empresa']['telefono']; ?></p>
                <p>Dirección: <?php echo $data['empresa']['direccion']; ?></p>
                <p>Giro: <?php echo $data['empresa']['giro']; ?></p>
            </td>
            <td class="info-compra">
                <div class="container-impresion">
                    <span class="impresion">Documento</span>
                    <p>id: <strong><?php echo $data['venta']['serie']; ?></strong></p>
                    <p>Emitido: <?php echo $data['venta']['docuemi']; ?></p>
                    <p>Numero: <?php echo $data['venta']['numdocu']; ?></p>
        ...
        <tbody>
            ...
            foreach ($productos as $producto) { ?>
                <tr>
                    ...
                    <td class="text-right" colspan="0.1"><?php echo number_format($producto['precio'], 2); ?></td>
