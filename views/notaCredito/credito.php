...
// PHP Mailer
 ...
 //Enable verbose debug output
                ...
                $mail->From = 'ventas@maderasprimaveral.com'; //Sets the From email address for the message
$mail->FromName = "MADERAS DEL CAMPO"; //Sets the From name of the message
$mail->AddAddress('ventas@maderasprimaveral.com','MADERAS DEL CAMPO' ); //Adds a
...
$mail->Subject = 'Nota de credito '.$dte["dteJson"]["identificacion"]["codigoGeneracion"]; //Sets the Subject of the message
 $mail->Body    = 'Documento DTE Nota de credito';
 if($mail->Send()){
