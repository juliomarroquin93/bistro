    ...
    <div class="card-body">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-cotizaciones-tab" data-bs-toggle="tab" data-bs-target="#nav-cotizaciones" type="button" role="tab" aria-controls="nav-cotizaciones" aria-selected="true">Historial</button>
                <button class="nav-link" id="nav-historial-tab" data-bs-toggle="tab" data-bs-target="#nav-historial" type="button" role="tab" aria-controls="nav-historial" aria-selected="false">Cotizaciones</button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
			...
			<input type="hidden" id="idCotizacion" name="idCotizacion">
			                <h5 class="card-title text-center"><i class="fas fa-list-alt"></i>Cotización</h5>
                <hr>
                <div class="row mb-2">
				                    <div class="col-md-2">
                        <label for="docuemi">Documento</label>
                    ...
                    <div class="col-md-6">
                        <div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">
							...
							<input type="text" id="chekExento" value="Normal" hidden>
                        </div>
                    </div>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                            <input class="form-control" type="text" id="gravadas" name="gravadas" placeholder="Ventas Gravadas" disabled>
                        </div>
					<label>13% IVA</label>
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                            <input class="form-control" type="text" id="iva" name="iva" placeholder="13% IVA" disabled>
                        </div>
											<label>1% IVA Retenido</label>
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                            <input class="form-control" type="text" id="ivaRete" name="ivaRete" placeholder="1% IVA Retenido" disabled>
                        </div>
