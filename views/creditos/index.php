                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="text" id="id_venta" placeholder="Numero de venta" readonly>
                        </div>
                        <span class="text-danger fw-bold" id="errorCliente"></span>
                        <span class="text-danger fw-bold" id="errorId_venta"></span>
                    </div>
                    <div class="col-md-12">
