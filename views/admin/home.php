            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <a class="mb-0 font-13" href="<?php echo BASE_URL . 'clientes2'; ?>">Detalle</a>
                    </div>
    ...
    <div class="col-12 col-lg-8">
        <div class="card radius-10">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-2 g-0 row-group text-center border-top">
                ...
                <div class="col">
                    <div class="p-3">
                        <h5 class="mb-0" id="totalVentas2">00</h5>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><span class="badge bg-primary text-white shadow-sm w-100"><?php echo $nuevo['cantidad']; ?></span>
                            </td>
